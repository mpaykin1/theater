const SEO = {
  ...
  '/chem-zanyatsya-tbilisi/': {
    ...
    description: 'Куда пойти сегодня в Тбилиси? Ответьте на 6 вопросов и получите персональную рекомендацию: спектакль, «Проявись» или индивидуальная театротерапевтическая работа.'
  }
};
