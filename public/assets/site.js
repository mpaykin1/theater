...
if(location.pathname.startsWith('/kak-ponyat-chego-ya-hochu')){const s=document.createElement('style');s.textContent='@media(max-width:900px){.two>*{min-width:0}.trust h2{font-size:36px!important;overflow-wrap:anywhere}}';document.head.appendChild(s)}